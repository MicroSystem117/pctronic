            ...
            <div class="text-white-75 small">
                <?php if (!empty($data['antenas_by_plan'])): ?>
                    <ul class="list-unstyled mb-0">
                        <?php foreach ($data['antenas_by_plan'] as $plan): ?>
                            <li class="d-flex justify-content-between align-items-center py-1 border-bottom border-secondary border-opacity-25">
                                <span><?php echo htmlspecialchars($plan['nombre_plan']); ?></span>
                                <span class="badge bg-secondary ms-2"><?php echo $plan['total_antenas']; ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
